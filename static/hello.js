...
function enableButtons () {
	...
	btnP = document.getElementById("input_greet_by_period");
	btnP.onclick=function(){greetByPeriod();};
	btnP.value = "Click for greet with period";
}
...
function greetByPeriod(){
	var request = gapi.client.helloworldendpoints.sayHelloPeriod({'name': name, 'period': period});
	request.execute(sayHelloCallback);
}
